      ...
      <div className="grid gap-3 md:grid-cols-1">
        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
          ...
          <div className="text-sm space-y-1">
            <div>
              ...
              <code className="ml-2 text-slate-900 font-medium">john.smith@email.com</code>
            </div>
            <div>
        ...
        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="font-medium text-slate-900">Customer User</span>
          </div>
          <div className="text-sm space-y-1">
            <div>
              <span className="text-slate-600">Email:</span>
              <code className="ml-2 text-slate-900 font-medium">customer@email.com</code>
            </div>
            <div>
              <span className="text-slate-600">Password:</span>
              <code className="ml-2 text-slate-900 font-medium">password123</code>
